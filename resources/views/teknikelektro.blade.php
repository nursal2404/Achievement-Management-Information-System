...
<head>
    <meta charset="utf-8">
    <title>Prestasi Prodi Teknik Elektro</title>
                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="#" class="nav-link active dropdown-toggle" data-bs-toggle="dropdown">Prestasi</a>
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="/teknik_elektro" class="dropdown-item active">Teknik Elektro</a>
                            <a href="teknik_mesin" class="dropdown-item">Teknik Mesin</a>
                            <a href="/arsitektur" class="dropdown-item">Arsitektur</a>
                            <a href="/sisteminformasi" class="dropdown-item">Sistem Informasi</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    ...
                    <h2 class="display-4 text-white animated zoomIn">Prodi Teknik Elektro</h2>
