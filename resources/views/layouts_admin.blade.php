...
<body>
 <!-- Main Page -->
  ...
  <!-- Sidebar -->
    ...
    <li class="nav-item {{ ($title == "Dasboard") ? 'active' : '' }}">
      ...
      <li class="nav-item {{ ($title == "Manajemen Mahasiswa") ? 'active' : '' }}">
      ...
      <li class="nav-item {{ ($title == "Manajemen Lomba") ? 'active' : '' }}">
        <a class="nav-link collapsed" href="/lomba" 
          aria-expanded="true" aria-controls="collapseBootstrap">
      ...
      <li class="nav-item {{ ($title == "Manajemen Prestasi") ? 'active' : '' }}">
      ...
      <li class="nav-item {{ ($title == "Manajemen Berita") ? 'active' : '' }}">
            ...
            <li class="nav-item dropdown no-arrow">             
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                @if( Auth::user()->profil != 0)
                  <img class="img-profile rounded-circle" src="{{ asset(Auth::user()->profil) }}" style="max-width: 60px">
                @else
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item {{ ($title == "Profil") ? 'active' : '' }}" href="/profil_admin/{{ Auth::user()->id }}">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Anda yakin ingin logout?</h5>
