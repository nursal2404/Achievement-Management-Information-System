                ...
                <div class="p-3">
                    <div class="card-body">
                      <form class="row g-3" action="/lomba" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row col-lg-12" id="dynamicLomba">
                        ...
                        <div class="mb-3">
                            <button type="button" name="add" id="dynamic-ar" class="btn btn-outline-primary ml-2 mr-2"><i class="fas fa-plus"></i>Tambah Tim</button>
                        </div>
